...
<div style="width: 100vw;height: 100vh;background:black;display: flex;flex-direction: column;flex-wrap: nowrap;align-content: center;justify-content: center;align-items: center; padding:0; margin:0;" id="box0">
  ...
  <h1 style="color: white;">
    ...
    <span class="date">
      <span class="date_month_short">Apr</span>
      <span class="date_year">2022</span>
    </span>
    <span class="ndash">–</span>
    <span class="tagline">Gaming Weekender</span>
  </h1>
</div>


<div style="width: 100vw; height: 100vh; background:black; display: flex; flex-direction: column; flex-wrap: nowrap; align-content: center; justify-content: center; align-items: center; padding:0; margin:0;" id="box1">
  <div id="key_details" class="key_details">
    <div>
      <h3>Key details</h3>
