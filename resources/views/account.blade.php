              ...
              <tbody>
                @foreach($user->orders as $order)
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-warning mx-1"><a href="/account/order/{{ $order->id }}">View</a></button>
                      <button class="btn btn-warning mx-1"><a target="_blank" href="/account/order/invoice/{{ $order->id }}">Invoice</a></button>
                    </td>
                  </tr>
                @endforeach
              </tbody>
